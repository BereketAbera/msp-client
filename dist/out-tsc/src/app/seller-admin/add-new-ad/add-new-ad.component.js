...
var AddNewAdComponent = /** @class */ (function () {
    function AddNewAdComponent(authService, snackBar, dialog, route, router, productService, fb) {
    ...
    AddNewAdComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    AddNewAdComponent.prototype.hours12 = function (date) {
        return (date.getHours() + 24) % 12 || 12;
    };
    AddNewAdComponent.prototype.buildWeekDays = function () {
        var _this = this;
    ...
    Object.defineProperty(AddNewAdComponent.prototype, "weekDays", {
        get: function () {
    ...
    AddNewAdComponent.prototype.getAMPM = function (date) {
        return date.getHours() >= 12 ? "PM" : "AM";
    };
    AddNewAdComponent.prototype.initOfferPickupTime = function () {
    ...
    AddNewAdComponent.prototype.onSubmit = function () {
        var _this = this;
    ...
    AddNewAdComponent.prototype.gotoSellAdmin = function () {
        this.router.navigate(["../"], { relativeTo: this.route });
    };
    AddNewAdComponent.prototype.filePreviewHandler = function (event) {
        var _this = this;
    ...
    AddNewAdComponent.prototype.checkDate = function (datestr, hhstr, mmstr) {
    ...
    AddNewAdComponent.prototype.checkFormValidity = function () {
    ...
    AddNewAdComponent.prototype.close = function () {
        this.showError = false;
    };
    AddNewAdComponent.prototype.showForm = function () {
        return this.authService.isAccountActive();
    };
    AddNewAdComponent.prototype.gotoGallery = function () {
        this.router.navigate(["../../gallery"], { relativeTo: this.route });
    };
    AddNewAdComponent = tslib_1.__decorate([
        Component({
    ...
    return AddNewAdComponent;
}());
export { AddNewAdComponent };
//# sourceMappingURL=add-new-ad.component.js.map