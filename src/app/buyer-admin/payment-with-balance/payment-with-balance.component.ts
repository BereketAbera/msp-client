...
export class PaymentWithBalanceComponent implements OnInit {
  ...
  constructor(public dialog: MatDialog,private cartService:CartService, private trnsService: TransactionService,  private fb: FormBuilder, private router: Router, private route: ActivatedRoute) { }
