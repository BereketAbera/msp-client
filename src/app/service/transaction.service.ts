...
export class TransactionService {
  ...
  createTransaction(transaction:Transaction){
    return this.http.post(transactionApi,transaction).pipe(
        catchError(this.handleError)
    );
  }
  createDeposit(transaction:Transaction){
    return this.http.post(transactionApi +"/deposit",transaction).pipe(
        catchError(this.handleError)
    );
  }
  acceptOrder(isOk:boolean,id:number|string){
      return this.http.post(transactionApi + "/acptordr",{id:id,isOk:isOk}).pipe(
      catchError(this.handleError)
      );
  }
  ...
  getCdCodeForTransaction(cd:number|string):Observable<QrCodeData>{
  ...
  listBuyerTransactions(usrId:number, filter = '', sortOrder = 'asc',
  pageNumber = 0, pageSize = 5):  Observable<BuyerTransaction[]> {
  ...
  listTransactions(usrId:number, filter = '', sortOrder = 'asc',
  pageNumber = 0, pageSize = 5):  Observable<Transaction[]> {
  ...
  listOrders(usrId:number, filter = '', sortOrder = 'asc',
  pageNumber = 0, pageSize = 5):  Observable<Transaction[]> {
  ...
  listSellersOrders(usrId:number, filter = '', sortOrder = 'asc',
  pageNumber = 0, pageSize = 5):  Observable<Transaction[]> {
