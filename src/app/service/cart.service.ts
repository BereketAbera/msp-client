...
export class CartService {
  ...
  addToCart(rsrvPrdct: ReserveProduct) {
    return this.http.post(reserveApi + '/order', rsrvPrdct).pipe(
      catchError(this.handleError)
    );
  }
  addToCartTest(rsrvPrdct: ReserveProduct) {
    return this.http.post(reserveApi + '/tstorder', rsrvPrdct).pipe(
      catchError(this.handleError)
    );
  }
  removeFromCart(rsrvPrdct: ReserveProduct) {
    return this.http.post(reserveApi + '/rmvrsrvdtl', rsrvPrdct).pipe(
      catchError(this.handleError)
    );
  }
