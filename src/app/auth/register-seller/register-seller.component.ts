...
export class RegisterSellerComponent implements OnInit {
  ...
  constructor(public dialog: MatDialog, private router: Router, private userService: UserService, private fb: FormBuilder) {
  ...
  onSubmit() {
    if (this.registrationForm.get('agreed').value) {
      return this.userService.registerUser(this.registrationForm.value).subscribe(
        res => {
          if (res['success']) {
